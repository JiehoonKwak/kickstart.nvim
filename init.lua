...
-- Disable line wrap and swap files
vim.opt.wrap = true
...
vim.cmd [[
  ...
  let &t_EI = "\e[6 q"  " Normal mode: block
]]
...
--  NOTE: Now handled by smart-splits.nvim for seamless zellij integration
...
require('lazy').setup({
  ...
  { -- Auto-switch IME to English on InsertLeave (for Korean input)
    'keaising/im-select.nvim',
    config = function()
      require('im_select').setup {
        default_im_select = 'com.apple.keylayout.ABC',
        default_command = 'macism',
        set_previous_events = { 'InsertEnter' }, -- restore previous IME when entering insert
      }
    end,
  },
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      vim.list_extend(ensure_installed, {
        ...
        'prettier', -- Used to format JS, TS, HTML, CSS, YAML, Markdown
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- NOTE: Disabled in favor of custom lualine setup in lua/custom/plugins/lualine.lua
